...
public class ColdChainMinuteController {
     ...
     * @return 信息
     */
    @PostMapping("/coldchain/minute/query")
    public RestResult queryHistoryByDate(@RequestBody Map<String, Object> params) {
        ...
        // 数据获取
        List<ColdChainMinute> coldChainMinutes = this.wrapperDataQuery(startTime, endTime, deviceNo);
        return RestResultUtil.success(coldChainMinutes);
    }
