...
public class DataMinuteController {
    ...
    public RestResult queryDataMinuteByDate(@RequestBody Map<String, Object> params) {
        ...
        // 数据获取
        List<DataMinute> dataMinutes = this.wrapperDataQuery(startTime, endTime, deviceNo, ConstUtil.HistoryType);
    ...
    public void exportDataMinuteToExcel(@RequestBody Map<String, Object> params, HttpServletResponse response) {
        ...
        for (String device : devices) {
            List<DataMinute> lists = this.wrapperDataQuery(startTime, endTime, device, ConstUtil.ExportType);
     ...
     * @return 信息
     */
    private List<DataMinute> wrapperDataQuery(String startTime, String endTime, String deviceNo, int type) {
        ...
        for (String tableName : queryTableName) {
            ...
            List<DataMinute> history = dataMinuteService.queryDataMinuteByDate(startDate, endDate, deviceNo, type);
