...
public interface ColdChainMinuteService extends IService<ColdChainMinute> {
     ...
     * @return 信息
     */
    List<ColdChainMinute> queryHistoryByDate(LocalDateTime start, LocalDateTime end, String deviceNo);
     ...
     * @return 信息
     */
    List<ColdChainMinute> queryHistoryByDate(LocalDateTime start, LocalDateTime end, String deviceNo, String monitor);
     ...
     * @return 信息
     */
    ColdChainMinute getOneData(String deviceNo, LocalDateTime dateTime);
}
